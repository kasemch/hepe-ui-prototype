  ...
  return (
    <main style={{ maxWidth: 1180, margin: "28px auto", padding: "0 20px 48px", fontFamily: "system-ui, sans-serif", color: "#0f172a" }}>
      ...
      <section style={{ borderTop: "1px solid #e2e8f0", paddingTop: 22 }}>
        ...
        <p style={{ color: "#64748b" }}>ปุ่มชุดนี้เป็น Human Gate และจะเปิดใช้เมื่อ authority-aware action wiring ผ่าน acceptance test</p>
      ...
      <footer style={{ marginTop: 32, color: "#64748b", fontSize: 12 }}>
        TQF3-REVIEW-06 / TQF3-UI-08 · structural validation only · academic authority remains human-controlled
      </footer>
    </main>
  );
}
