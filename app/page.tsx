...
export default function Home(){
 return <main className="shell">
  ...
  <section className="workspace">
   ...
   <section className="hero-modern" aria-labelledby="today-title" data-tour="workspace-hero"><div className="brand-kicker">WORK-FIRST · ONE ENTRY → MANY OUTPUTS</div><h2 id="today-title">วันนี้เริ่มงานจากตรงนี้</h2><p>เปิด My Courses เพื่อเลือกรายวิชา หรือใช้ Quick Entry เพื่อบันทึกงานหลังสอน แล้วระบบนำข้อมูลเดียวกันไปใช้กับ Teaching Record, Evidence และ Plan vs Actual โดยคง Human Authority และ RLS เดิม</p><div className="hero-actions"><a className="button" href="/my-courses" data-tour="my-courses">เปิดรายวิชาของฉัน</a><a className="button secondary" href="/pilot-entry" data-tour="quick-entry">บันทึกหลังสอน / Quick Entry</a><a className="button secondary" href="/teaching">Teaching Record</a><a className="button secondary" href="/plan-actual">Plan vs Actual</a></div></section>
