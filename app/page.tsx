const modules = [
  ['programme','Programme Overview'],['curriculum','Curriculum Structure'],['study-plan','Study Plan'],['traceability','PLO / Course Traceability'],['mapping','PLO × Course / I-R-M'],['evidence','Evidence Explorer'],['qa','QA / CPRR'],['reviews','Review Queue'],['calendar','Academic Tasks'],['audit','Provenance'],['ai','AI Advisory'],['governance','Settings / Governance']
];
...
export default function Home(){
 return <main className="shell">
  <aside className="sidebar">
   ...
   <nav className="nav sans" aria-label="HEPE modules"><a className="active" href="/">Command Center</a><a href="/pilot">Controlled Pilot</a>{modules.map(([s,l])=><a key={s} href={`/${s}`}>{l}</a>)}</nav>
  </aside>
