export default function Home() {
  return (
    <main style={{maxWidth:820,margin:"40px auto",padding:24,background:"white",borderRadius:16}}>
      <h1>HEPE · BED-HEPE</h1>
      <p><strong>Prototype · NON-PRODUCTION</strong></p>
      <h2>Academic Command Center</h2>
      <p>This canonicalized source package preserves the HEPE prototype identity while adding controlled academic review workspaces.</p>
      ...
      <section style={{marginTop:28,padding:18,border:"1px solid #e2e8f0",borderRadius:14}}>
        ...
        <small style={{color:"#64748b"}}>
          Controlled pilot only. Export remains locked until blocking findings are resolved by authorized human review.
        </small>
      </section>
    </main>
  );
