...
await browser.close();
if(failures.length){console.error('RUNNER_BROWSER_ACCEPTANCE_FAIL\n'+failures.join('\n'));process.exit(1);}
console.log('RUNNER_RESPONSIVE_ACCEPTANCE_PASS viewports=1440,1024,768,390');
console.log('SCOPED_AUTOMATED_ACCESSIBILITY_ACCEPTANCE PASS wcag2a,wcag2aa serious_critical=0');
console.log('RUNNER_FULL_ROUTE_BROWSER_ACCEPTANCE_PASS routes=23');
