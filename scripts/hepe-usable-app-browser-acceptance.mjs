...
const routes=['/','/pilot-entry','/my-courses','/plan-actual','/evidence','/findings'];
...
try{
  ...
  console.log(`HEPE_RESPONSIVE_BROWSER_ACCEPTANCE_PASS base=${base} routes=6 viewports=1440,1024,768,390`);
  console.log('HEPE_ACCESSIBILITY_CRITICAL_BROWSER_ACCEPTANCE_PASS wcag2a,wcag2aa serious_critical=0');
} finally {
  await browser.close();
}
